...
#define CLI_OPT(cmd, name, help) \
    cli_register_optarg(cmd, name, CLI_CMD_OPTIONAL_ARGUMENT, PRIVILEGE_UNPRIVILEGED, MODE_CONFIG, help, NULL, NULL, NULL)

#define CLI_OPT_A(cmd, name, help) \
    cli_register_optarg(cmd, name, CLI_CMD_ARGUMENT, PRIVILEGE_UNPRIVILEGED, MODE_CONFIG, help, NULL, NULL, NULL)


/** macros for get option value
 * */
#define CLI_OPT_V(cli, name) \
    cli_get_optarg_value(cli, name, NULL)
